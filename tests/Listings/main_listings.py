...
physics1 = C3PO.tracer(pythonFile = file1, stdoutFile = file3, lWriter = listingW)(physicsScalarTransient)
physics2 = C3PO.tracer(pythonFile = file2, stdoutFile = file4, lWriter = listingW)(physicsScalarTransient)
newfixedPointCoupler = C3PO.tracer(stdoutFile = file5, lWriter = listingW)(C3PO.fixedPointCoupler)
C3PO.exchanger = C3PO.tracer(lWriter = listingW)(C3PO.exchanger)
